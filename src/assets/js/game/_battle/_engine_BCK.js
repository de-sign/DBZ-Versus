...
Object.assign(
    BattleEngine.prototype, {
                ...
                if( aHurt.length ){
                    aHurt.forEach( oHurt => {
                        ...
                        if( oHurt.oOpponent.oAnimation.oFrame.oStatus.bGuard ){
                            ...
                            if( nDamage ){
                                oHurt.oOpponent.takeHit(nDamage);
        ...
        stayInArea: function(oPlayer){
            // Check
            let oBoxPlayer = oPlayer.getBox('oPositionBox')[0],
                nPriority = oPlayer.oGatling.oCurrent ? 1 : 0,
                sMove = null;
            const oBoxArea = this.oArea.getBox(),
                ...
                nDown = this.oArea.oPosition.nY + (oBoxArea.bottom - oBoxArea.originY) - GAME.oSettings.oPositionPoint.character.nGapY;
            ...
            if( nDown < oPlayer.oLayer.oPosition.nY + ( oBoxPlayer.nY + oBoxPlayer.nHeight ) ){
                ...
                oBoxPlayer = oPlayer.getBox('oPositionBox')[0];
