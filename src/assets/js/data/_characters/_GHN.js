GAME.oData.oCharacter.GHN = {
    ...
    oAnimations: {
        ...
        GHT_light_first: [
            ...
            {
                nFrame: 2,
                sFrame: 'GHT_light_first'
            },
            {
                nFrame: 4,
                sFrame: 'GHT_light_first_active',
                oStatus: {
                    bCancel: true
                }
            },
        ...
        GHT_light_second: [
            ...
            {
                nFrame: 2,
                sFrame: 'GHT_light_second'
            },
            {
                nFrame: 4,
                sFrame: 'GHT_light_second_active',
                oStatus: {
                    bCancel: true
                }
            },
        ...
        GHT_light_third: {
            ...
            aFrames: [
                ...
                {
                    nFrame: 2,
                    sFrame: 'GHT_light_third'
                },
                {
                    nFrame: 4,
                    sFrame: 'GHT_light_third_active',
                    oStatus: {
                        bCancel: true
                    }
                },
        ...
        GHT_tracker_second: {
            ...
            aFrames: [
                ...
                {
                    nFrame: 4,
                    sFrame: 'GHT_tracker_second',
                },
                {
                    nFrame: 6,
                    sFrame: 'GHT_tracker_second_active',
                    oStatus: {
                        bCancel: true
                    }
                },
        ...
        GHT_super: [
            ...
            {
                nFrame: 10,
                sFrame: 'GHT_super_second',
                aHurtBox: null
            },
            {
                nFrame: 4,
                sFrame: 'GHT_super_third',
                aHurtBox: null
            },
            {
                nFrame: 40,
    ...
    oCommands: {
        aOffense: [
            ...
            },
            {
                ...
                sCod: 'tracker_first',
                sName: 'Tracker',
                sAnimation: 'GHT_tracker_first',
                nGatlingLevel: 1,
                oSelfCancel: {
                    tracker_second: {
                        sCod: 'tracker_second',
                        sName: '2nd',
                        sAnimation: 'GHT_tracker_second',
                        oStun: {
                            nBlock: 8,
                            nHit: 18,
                            sHitAnimation: 'hit_light'
